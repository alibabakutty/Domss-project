...
const ReportWithItems = () => {
	...
	const loadReport = async () => {
		const response = await axios.get(
			"http://localhost:9080/orders/getInformation"
		);
	...
	return (
		<>
			<div className="">
				...
				<div className="h-10 flex justify-between text-[14px] p-2">
			...
			<div className="overflow-x-auto w-full h-[87vh] p-1">
                            ...
                            className={` h-[18px] leading-3 whitespace-nowrap ${selectedIndex === rowIndex ? "bg-amber-100" : ""}  `}>
								{
									...
									className={`outline-0 border-x px-1 text-[13px] ${
										key === "orderQty" ||
