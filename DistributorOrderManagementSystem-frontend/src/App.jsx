    ...
    <>
      <BrowserRouter>
        <Routes>
          ...
          <Route
            path="alterDistributorMaster/:distributorCode"
            element={<AlterDistributorMaster />}
          />
          ...
          <Route
            path="alterVoucherTypeMaster/:voucherTypeName"
            element={<AlterVoucherTypeMaster />}
          />
          ...
          <Route
            path="displayDistributor/:distributorCode"
            element={<DisplayDistributorMaster />}
          />
          ...
          <Route
            path="displayVoucherTypeName/:voucherTypeName"
            element={<DisplayVoucherTypeMaster />}
          />
